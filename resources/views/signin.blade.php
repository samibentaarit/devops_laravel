...
<section class="vh-100" style="padding-top: 200px; padding-bottom: 500px; margin-left:150px "  >
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <form style="width: 23rem; ; margin-left :100px ">
            ...
            <p class=""><a class="text-muted" href="#!">Forgot password?</a></p>
      ...
      <img src="{{ Vite::asset('resources/assetsf/images/banner1.jpg') }}" class="img-fluid"

    alt="Login image" style="width: 80%; height: 450px; object-fit: cover; object-position: left; margin-left: -70px ; margin-top:-40px ">
</div>
